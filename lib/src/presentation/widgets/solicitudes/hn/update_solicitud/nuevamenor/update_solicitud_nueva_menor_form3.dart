...
class UpdateSolicitudNuevaMenorForm3 extends StatefulWidget {
  final PageController controller;
  const UpdateSolicitudNuevaMenorForm3({
    super.key,
    required this.controller,
  });

  @override
  State<UpdateSolicitudNuevaMenorForm3> createState() =>
      _UpdateSolicitudNuevaMenorForm3State();
}

class _UpdateSolicitudNuevaMenorForm3State
    extends State<UpdateSolicitudNuevaMenorForm3> {
          ...
          children: [
            ...
            Column(
              children: [
                ...
                if (cubit.state.paisCasaCodigo == 'HN') ...[
                  ...
                  CatalogoValorNacionalidad(
                    selectedItem: ItemNacionalidad(
                      ...
                      nombre: cubit.state.departamentoNegocioNombre,
                      relacion: '',
                    ),
                    ...
                    onChanged: (item) {
                      ...
                      cubit.onFieldChanged(
                        () => cubit.state.copyWith(
                          ...
                          departamentoNegocioNombre: item.nombre,
                        ),
                      );
                    },
                  ),
                  ...
                  CatalogoValorNacionalidad(
                    selectedItem: ItemNacionalidad(
                      ...
                      nombre: cubit.state.municipioNegocioNombre,
                      relacion: '',
                    ),
                    where: cubit.state.departamentoNegocioCodigo,
                    validator: (value) =>
                        ClassValidator.validateRequired(value?.valor),
                    onChanged: (item) {
                      if (item == null || !mounted) return;
                      ...
                      cubit.onFieldChanged(
                        () => cubit.state.copyWith(
                          ...
                          municipioNegocioNombre: item.nombre,
                        ),
                      );
                    },
                    codigo: 'MUN',
                  ...
                  CatalogoValorNacionalidad(
                    selectedItem: ItemNacionalidad(
                      ...
                      nombre: cubit.state.aldeaNegocioNombre,
                      relacion: '',
                    ),
                    where: cubit.state.municipioNegocioCodigo,
                    codigo: 'ALD',
                    validator: (value) =>
                        ClassValidator.validateRequired(value?.valor),
                    ...
                    onChanged: (value) {
                      cubit.onFieldChanged(
                        () => cubit.state.copyWith(
                          ...
                          aldeaNegocioNombre: value?.nombre,
                        ),
                      );
                    },
                ...
                SearchDropdownWidget(
                  selectedItem: Item(
                    name: cubit.state.condicionNegocioNombre,
                  ...
                  onChanged: (item) {
                    ...
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(
                        ...
                        condicionNegocioNombre: item.name,
                      ),
                    );
                  },
                ...
                const Gap(30),
                BlocBuilder<UpdateSolicitudNuevaMenorCubit,

...
class UpdateSolicitudNuevaMenorForm2 extends StatefulWidget {
  final PageController controller;
  const UpdateSolicitudNuevaMenorForm2({
    super.key,
    required this.controller,
  });

  @override
  State<UpdateSolicitudNuevaMenorForm2> createState() =>
      _UpdateSolicitudNuevaMenorForm2State();
}

class _UpdateSolicitudNuevaMenorForm2State
    extends State<UpdateSolicitudNuevaMenorForm2> {
                    ...
                    if (item.valor != 'HN') {
                      cubit.onFieldChanged(
                        () => cubit.state.copyWith(
                          ...
                          aldeaCodigo: item.valor,
                          aldeaNombre: item.nombre,
                  ...
                  CatalogoValorNacionalidad(
                    ...
                    onChanged: (item) {
                      ...
                      cubit.onFieldChanged(
                        () => cubit.state.copyWith(
                          departamentoCasaCodigo: item.valor,
                          departamentoCasaNombre: item.nombre,
                        ),
                      );
                    },
                  ),
                  ...
                  CatalogoValorNacionalidad(
                    ...
                    onChanged: (item) {
                      ...
                      cubit.onFieldChanged(
                        () => cubit.state.copyWith(
                          municipioCasaCodigo: item.valor,
                          municipioCasaNombre: item.nombre,
                        ),
                      );
                    },
                  ),

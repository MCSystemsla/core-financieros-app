...
class UpdateSolicitudAsalariadoForm7 extends StatefulWidget {
  final PageController controller;
  const UpdateSolicitudAsalariadoForm7({
    super.key,
    required this.controller,
  });

  @override
  State<UpdateSolicitudAsalariadoForm7> createState() =>
      _UpdateSolicitudAsalariadoForm7State();
}

class _UpdateSolicitudAsalariadoForm7State
    extends State<UpdateSolicitudAsalariadoForm7> {
              ...
              children: [
                CatalogoValorNacionalidad(
                  selectedItem: ItemNacionalidad(
                    id: 0,
                    valor: cubit.state.paisDestinoCodigo,
                    nombre: cubit.state.paisDestinoNombre,
                    relacion: '',
                  ),
                  validator: (value) =>
                ...
                CatalogoValorNacionalidad(
                  selectedItem: ItemNacionalidad(
                    ...
                    nombre: cubit.state.departamentoDestinoNombre,
                    relacion: '',
                  ),
                  validator: (value) =>
                      ClassValidator.validateRequired(value?.valor),
                  ...
                  where: cubit.state.departamentoDestinoCodigo,
                  codigo: 'DEP',
                  onChanged: (item) {
                    if (item == null || !mounted) return;
                    setState(() {
                ...
                CatalogoValorNacionalidad(
                  ...
                  title: 'Aldea Destino',
                  where: cubit.state.aldeaDestinoCodigo,
                  codigo: 'ALD',
                  onChanged: (item) {
                    if (item == null || !mounted) return;
                    cubit.onFieldChanged(

...
class UpdateSolicitudAsalariadoForm6 extends StatefulWidget {
  final PageController controller;
  const UpdateSolicitudAsalariadoForm6({
    super.key,
    required this.controller,
  });

  @override
  State<UpdateSolicitudAsalariadoForm6> createState() =>
      _UpdateSolicitudAsalariadoForm6State();
}

class _UpdateSolicitudAsalariadoForm6State
    extends State<UpdateSolicitudAsalariadoForm6> {
            ...
            Column(
              children: [
                OutlineTextfieldWidget(
                  initialValue: cubit.state.nombreFamiliarCercano,
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.direccionFamiliarCercano,
                ...
                const Gap(30),
                CountryInput(
                  initialValue: cubit.state.telefonoFamiliarCercano,
                  isRequired: false,
                  maxLength: 15,

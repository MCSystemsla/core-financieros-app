              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      initialValue: state.tiempoLaboral,
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      initialValue: state.salarioNetoMensual.toCurrencyString(),
                      validator: (value) =>
                          ClassValidator.validateRequired(value),
                      ...
                      onChange: (value) {
                        ...
                        final total =
                            cubit.state.salarioNetoCordoba + salarioNeto;
                        cubit.onFieldChanged(
                          () => state.copyWith(
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      initialValue: state.otrosIngresos.toCurrencyString(),

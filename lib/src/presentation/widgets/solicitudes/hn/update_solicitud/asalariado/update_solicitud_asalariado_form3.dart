...
class UpdateSolicitudAsalariadoForm3 extends StatefulWidget {
  final PageController controller;
  const UpdateSolicitudAsalariadoForm3({
    super.key,
    required this.controller,
  });

  @override
  State<UpdateSolicitudAsalariadoForm3> createState() =>
      _UpdateSolicitudAsalariadoForm3State();
}

class _UpdateSolicitudAsalariadoForm3State
    extends State<UpdateSolicitudAsalariadoForm3> {
            ...
            Column(
              children: [
                ...
                OutlineTextfieldWidget(
                  initialValue: cubit.state.cargo,
                  hintText: 'Cargo',
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.nombreTrabajo,
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.direccionTrabajo,
                  validator: (value) => ClassValidator.validateRequired(value),
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.barrioTrabajo,
                  validator: (value) => ClassValidator.validateRequired(value),
                ...
                const Gap(30),
                CountryInput(
                  initialValue: cubit.state.telefonoTrabajo,
                  isRequired: false,
                  maxLength: 15,
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.tiempoLaboral,
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.lugarTrabajoAnterior,
                ...
                OutlineTextfieldWidget(
                  initialValue:
                      cubit.state.salarioNetoCordoba.toCurrencyString(),
                  validator: (value) => ClassValidator.validateRequired(value),
                ...
                OutlineTextfieldWidget(
                  initialValue:
                      cubit.state.otrosIngresosCordoba.toCurrencyString(),
                ...
                const Gap(30),
                OutlineTextfieldWidget(
                  initialValue: cubit.state.fuenteOtrosIngresos,

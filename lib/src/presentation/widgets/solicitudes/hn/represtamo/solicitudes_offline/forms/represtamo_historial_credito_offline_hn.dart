...
class ReprestamoHistorialCreditoOfflineHn extends StatefulWidget {
  final PageController controller;
  final String uuid;
  const ReprestamoHistorialCreditoOfflineHn({
    super.key,
  ...
  @override
  State<ReprestamoHistorialCreditoOfflineHn> createState() =>
      _ReprestamoHistorialCreditoOfflineHnState();
}

class _ReprestamoHistorialCreditoOfflineHnState
    extends State<ReprestamoHistorialCreditoOfflineHn> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final historialesCreditos =
        context.watch<SolicitudReprestamoHnCubit>().state.historialCredito;
    final localDbProvider = global<SolicitudesHnBoxService>();
              ...
              onTap: () => showHistorialCreditoOptionsBottomSheet(
                ...
                onEdit: () {
                  _createCreditoModalBottomSheet(
                    context,
                    cubit: context.read<SolicitudReprestamoHnCubit>(),
                    isUpdate: true,
                    cuota: e.cuota,
                    saldo: e.saldo,
                    estadoCodigo: e.estadoCodigo,
                ...
                onDelete: () {
                  context
                      .read<SolicitudReprestamoHnCubit>()
...
_createCreditoModalBottomSheet(
  ...
  required SolicitudReprestamoHnCubit cubit,
  String? entidad,
  int? monto,
...
class CreateCreditoContainerForm extends StatefulWidget {
  final bool isUpdate;
  final SolicitudReprestamoHnCubit cubit;

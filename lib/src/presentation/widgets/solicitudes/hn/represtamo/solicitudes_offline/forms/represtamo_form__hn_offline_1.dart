...
class ReprestamoFormHNOffline1 extends StatefulWidget {
  final PageController controller;
  const ReprestamoFormHNOffline1({
    super.key,
    required this.controller,
  });

  @override
  State<ReprestamoFormHNOffline1> createState() =>
      _ReprestamoFormHNOffline1State();
}

class _ReprestamoFormHNOffline1State extends State<ReprestamoFormHNOffline1>
                ...
                Column(
                  children: [
                    OutlineTextfieldWidget(
                      initialValue: state.nombreCompleto,
                    ...
                    const Gap(30),
                    CountryInput(
                      initialValue: state.celularReprestamo,
                    ...
                    SheetSearchDropdown(
                      selectedItem: Item(
                        name: state.tieneVinculoEstadosUnidos,
                        value: state.tieneVinculoEstadosUnidos,
                      ),
                    ...
                    if (state.tieneVinculoEstadosUnidos ==
                        'input.yes'.tr()) ...[
                      const Gap(30),
                      OutlineTextfieldWidget(
                        initialValue: state.vinculoEstadosUnidosDescripcion,
                        isRequired: true,
                      ...
                      SheetSearchDropdown(
                        selectedItem: Item(
                          name: state.tieneIdentificacionEstadosUnidos,
                          value: state.tieneIdentificacionEstadosUnidos,
                        ),

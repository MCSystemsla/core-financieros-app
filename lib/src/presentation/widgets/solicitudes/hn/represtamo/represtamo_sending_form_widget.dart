...
class ReprestamoSendingFormWidget extends StatefulWidget {
  ...
  State<ReprestamoSendingFormWidget> createState() =>
      _ReprestamoSendingFormWidgetState();
}

class _ReprestamoSendingFormWidgetState
    extends State<ReprestamoSendingFormWidget> {
  @override
  void initState() {
    super.initState();
    context.read<SolicitudReprestamoHnCubit>().createSolicitudReprestamo();
  }

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<SolicitudReprestamoHnCubit, SolicitudReprestamoHnState>(
          ...
          body: switch (state.status) {
            ...
            Status.done => const Padding(
                ...
                child: DownloadCatalogoLoading(
                  ...
                  text: 'Solicitud represtamo enviada exitosamente!!\n\n',
                  repeat: false,

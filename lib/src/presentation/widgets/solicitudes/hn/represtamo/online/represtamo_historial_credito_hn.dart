...
class ReprestamoHistorialCreditoHn extends StatefulWidget {
  final PageController controller;
  const ReprestamoHistorialCreditoHn({
    super.key,
    required this.controller,
  });

  @override
  State<ReprestamoHistorialCreditoHn> createState() =>
      _ReprestamoHistorialCreditoHnState();
}

class _ReprestamoHistorialCreditoHnState
    extends State<ReprestamoHistorialCreditoHn> {
  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<SolicitudReprestamoHnCubit>().state;
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    SearchDropdownWidget(
                      selectedItem:
                          Item(name: estadoCodigo, value: estadoCodigo),

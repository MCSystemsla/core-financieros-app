...
class AsalariadoHistorialCreditoHn extends StatefulWidget {
  final PageController controller;
  const AsalariadoHistorialCreditoHn({
    super.key,
    required this.controller,
  });

  @override
  State<AsalariadoHistorialCreditoHn> createState() =>
      _AsalariadoHistorialCreditoHnState();
}

class _AsalariadoHistorialCreditoHnState
    extends State<AsalariadoHistorialCreditoHn> {
  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<SolicitudAslariadoHnCubit>().state;

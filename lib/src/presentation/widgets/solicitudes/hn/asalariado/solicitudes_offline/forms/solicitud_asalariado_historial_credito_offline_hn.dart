...
class SolicitudAsalariadoHistorialCreditoOfflineHn extends StatefulWidget {
  final PageController controller;
  final String uuid;
  const SolicitudAsalariadoHistorialCreditoOfflineHn({
    super.key,
  ...
  @override
  State<SolicitudAsalariadoHistorialCreditoOfflineHn> createState() =>
      _SolicitudAsalariadoHistorialCreditoOfflineHnState();
}

class _SolicitudAsalariadoHistorialCreditoOfflineHnState
    extends State<SolicitudAsalariadoHistorialCreditoOfflineHn> {
  @override
  void initState() {
    super.initState();
    final cubit = context.read<SolicitudAslariadoHnCubit>();
    final localDbProvider = global<SolicitudesHnBoxService>();
    final historialesCreditos = localDbProvider.getHistorialCredito(
      uuid: widget.uuid,
    );
    cubit.saveHistorialesCreditoOnState(
      historialCredito: historialesCreditos.map((e) {
  ...
  Widget build(BuildContext context) {
    final historialesCreditos =
        context.watch<SolicitudAslariadoHnCubit>().state.historialCredito;
    final localDbProvider = global<SolicitudesHnBoxService>();
              ...
              onTap: () => showHistorialCreditoOptionsBottomSheet(
                ...
                onEdit: () {
                  _createCreditoModalBottomSheet(
                    context,
                    cubit: context.read<SolicitudAslariadoHnCubit>(),
                    isUpdate: true,
                    cuota: e.cuota,
                    saldo: e.saldo,
                    estadoCodigo: e.estadoCodigo,
...
_createCreditoModalBottomSheet(
  ...
  required SolicitudAslariadoHnCubit cubit,
  bool isUpdate = false,
  String? entidad,
  int? monto,
...
class CreateCreditoContainerForm extends StatefulWidget {
  final bool isUpdate;
  final SolicitudAslariadoHnCubit cubit;
              ...
              child: Column(
                children: [
                  ...
                  SearchDropdownWidget(
                    selectedItem:
                        Item(name: tipoMonedaCodigo, value: tipoMonedaCodigo),
                    codigo: 'MONEDA',
                    title: 'Tipo Moneda',
                    validator: (value) =>
                  ...
                  const Gap(20),
                  SearchDropdownWidget(
                    selectedItem: Item(name: estadoCodigo, value: estadoCodigo),

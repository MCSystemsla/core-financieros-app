...
class SolicitudAsalariadoOffline2 extends StatefulWidget {
  final PageController controller;
  const SolicitudAsalariadoOffline2({
    super.key,
    required this.controller,
  });

  @override
  State<SolicitudAsalariadoOffline2> createState() =>
      _SolicitudAsalariadoOffline2State();
}

class _SolicitudAsalariadoOffline2State
    extends State<SolicitudAsalariadoOffline2>
                  ...
                  children: [
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        id: 0,
                        valor: state.paisCasaCodigo,
                        nombre: state.paisCasaCodigo,
                        relacion: '',
                      ),
                      validator: (value) =>
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        id: 0,
                        valor: state.departamentoCasaCodigo,
                        nombre: state.departamentoCasaCodigo,
                        relacion: '',
                      ),
                      validator: (value) =>
                          ClassValidator.validateRequired(value?.valor),
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        id: 0,
                        valor: state.municipioCasaCodigo,
                        nombre: state.municipioCasaCodigo,
                        relacion: '',
                      ),
                      validator: (value) =>
                          ClassValidator.validateRequired(value?.valor),
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        id: 0,
                        valor: state.aldeaCodigo,
                        nombre: state.aldeaCodigo,
                        relacion: '',
                      ),
                      validator: (value) =>
                          ClassValidator.validateRequired(value?.valor),
                    ...
                    OutlineTextfieldWidget(
                      initialValue: state.direccionCasa,
                      validator: (value) =>
                    ...
                    SearchDropdownWidget(
                      selectedItem: Item(
                        name: state.condicionCasaCodigo,
                        value: state.condicionCasaCodigo,
                      ),
                      validator: (value) =>
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      initialValue: state.anosResidirCasa.toString(),
                      validator: (value) =>
                          ClassValidator.validateRequired(value),

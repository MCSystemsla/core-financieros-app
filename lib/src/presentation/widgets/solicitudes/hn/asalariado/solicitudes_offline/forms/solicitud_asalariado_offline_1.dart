...
class SolicitudAsalariadoOffline1 extends StatefulWidget {
  final PageController controller;
  const SolicitudAsalariadoOffline1({
    super.key,
    required this.controller,
  });

  @override
  State<SolicitudAsalariadoOffline1> createState() =>
      _SolicitudAsalariadoOffline1State();
}
                ...
                Column(
                  children: [
                    if (actions
                      ...
                      if (state.esGrupal == 'input.yes'.tr()) ...[
                        const Gap(30),
                        SearchDropdownWidget(
                          key: const Key('grupoDropdown'),
                          selectedItem: Item(
                            name: cubit.state.grupoCodigoNombre,
                    ...
                    SearchDropdownWidget(
                      selectedItem: Item(
                        name: state.tipoPersonaCnbsidCodigo,
                        value: state.tipoPersonaCnbsidCodigo,
                      ),
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        ...
                        nombre: state.paisNacimientoCodigo,
                        relacion: '',
                      ),
                      codigo: 'PAIS',
                      onChanged: (item) {
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        id: 0,
                        valor: state.nacinalidad,
                        nombre: state.nacinalidad,
                        relacion: '',
                      ),
                    ...
                    CatalogoValorNacionalidad(
                      selectedItem: ItemNacionalidad(
                        ...
                        nombre: state.paisEmisorCedulaCodigo,
                        relacion: '',
                      ),
                      codigo: 'PAIS',
                    ...
                    OutlineTextfieldWidget(
                      ...
                      icon:
                          Icon(Icons.event, color: AppColors.getPrimaryColor()),
                      textInputType: TextInputType.datetime,
                      textCapitalization: TextCapitalization.none,
                    ...
                    OutlineTextfieldWidget(
                      ...
                      icon:
                          Icon(Icons.email, color: AppColors.getPrimaryColor()),

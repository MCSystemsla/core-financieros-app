...
class SolicitudAsalariadoOffline9 extends StatefulWidget {
  final PageController controller;
  const SolicitudAsalariadoOffline9({
    super.key,
    required this.controller,
  });

  @override
  State<SolicitudAsalariadoOffline9> createState() =>
      _SolicitudAsalariadoOffline9State();
}
                ...
                Column(
                  children: [
                    SearchDropdownWidget(
                      selectedItem: Item(
                        name: state.sectorCodigo,
                        value: state.sectorCodigo,
                      ),
                      validator: (value) =>
                    ...
                    SearchDropdownWidget(
                      selectedItem:
                          const Item(name: 'Lempira', value: 'CORDOBA'),
                      validator: (value) =>
                          ClassValidator.validateRequired(value?.value),
                    ...
                    if (state.propositoCodigo.isNotEmpty) ...[
                      const Gap(30),
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (ctx) => BlocProvider.value(
                                value:
                                    context.read<SolicitudAslariadoHnCubit>(),

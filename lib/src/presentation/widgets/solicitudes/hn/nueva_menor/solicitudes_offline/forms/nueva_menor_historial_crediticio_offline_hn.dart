...
class NuevaMenorHistorialCrediticioOfflineHn extends StatefulWidget {
  final PageController controller;
  final String uuid;
  const NuevaMenorHistorialCrediticioOfflineHn({
    super.key,
  ...
  @override
  State<NuevaMenorHistorialCrediticioOfflineHn> createState() =>
      _NuevaMenorHistorialCrediticioOfflineHnState();
}

class _NuevaMenorHistorialCrediticioOfflineHnState
    extends State<NuevaMenorHistorialCrediticioOfflineHn> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final historialesCreditos =
        context.watch<SolicitudNuevaMenorHnCubit>().state.historialCredito;
    final localDbProvider = global<SolicitudesHnBoxService>();
              ...
              onTap: () => showHistorialCreditoOptionsBottomSheet(
                ...
                onEdit: () {
                  _createCreditoModalBottomSheet(
                    context,
                    cubit: context.read<SolicitudNuevaMenorHnCubit>(),
                    isUpdate: true,
                    cuota: e.cuota,
                    saldo: e.saldo,
                    estadoCodigo: e.estadoCodigo,
...
_createCreditoModalBottomSheet(
  ...
  required SolicitudNuevaMenorHnCubit cubit,
  String? entidad,
  int? monto,
...
class CreateCreditoContainerForm extends StatefulWidget {
  final bool isUpdate;
  final SolicitudNuevaMenorHnCubit cubit;

...
class NuevaMenorHistorialCrediticioHn extends StatefulWidget {
  final PageController controller;

  const NuevaMenorHistorialCrediticioHn({
    super.key,
    required this.controller,
  });

  @override
  State<NuevaMenorHistorialCrediticioHn> createState() =>
      _NuevaMenorHistorialCrediticioHnState();
}

class _NuevaMenorHistorialCrediticioHnState
    extends State<NuevaMenorHistorialCrediticioHn> {
  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<SolicitudNuevaMenorHnCubit>().state;

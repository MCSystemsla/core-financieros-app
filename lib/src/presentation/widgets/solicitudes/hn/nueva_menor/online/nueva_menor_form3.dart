                ...
                Column(
                  children: [
                    OutlineTextfieldWidget(
                      key: const ValueKey('nombreNegocio'),
                      isRequired: true,
                      inputFormatters: [
                    ...
                    if (state.paisCasaCodigo == 'HN') ...[
                      ...
                      CatalogoValorNacionalidad(
                        key: const ValueKey('departamentoNegocioCodigo'),
                        where: state.paisCasaCodigo,
                        validator: (value) =>
                      ...
                      const Gap(30),
                      CatalogoValorNacionalidad(
                        key: const ValueKey('municipioNegocioCodigo'),
                      ...
                      const Gap(30),
                      CatalogoValorNacionalidad(
                        key: const ValueKey('aldeaNegocioCodigo'),
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      key: const ValueKey('caserioNegocio'),
                      inputFormatters: [
                        UpperCaseTextFormatter(),
                      ],
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      key: const ValueKey('direccionNegocio'),
                      isRequired: true,
                      inputFormatters: [
                        UpperCaseTextFormatter(),
                      ],
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      key: const ValueKey('barrioNegocio'),
                      isRequired: true,
                      inputFormatters: [
                        UpperCaseTextFormatter(),
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      key: const ValueKey('tiempoFuncionamientoNegocio'),
                      isRequired: true,
                      validator: (value) =>
                          ClassValidator.validateRequired(value),
                    ...
                    SearchDropdownWidget(
                      key: const ValueKey('sectorCodigo'),
                      isRequired: true,
                      validator: (value) =>
                    ...
                    const Gap(30),
                    SearchDropdownWidget(
                      key: const ValueKey('condicionNegocioCodigo'),
                      isRequired: true,
                      validator: (value) =>
                          ClassValidator.validateRequired(value?.value),
                      codigo: 'TIPOVIVIENDA',
                    ...
                    const Gap(30),
                    CountryInput(
                      key: const ValueKey('telefonoNegocio'),
                      maxLength: 15,
                    ...
                    const Gap(30),
                    CountryInput(
                      key: const ValueKey('celularNegocio'),
                      countryCodeInput: CountryCodeInput.hn,
                      isRequired: true,
                      maxLength: 15,
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      key: const ValueKey('puestoNegocio'),
                      isRequired: true,
                      validator: (value) =>
                          ClassValidator.validateRequired(value),
                    ...
                    BlocBuilder<SolicitudNuevaMenorHnCubit,
                      ...
                      builder: (context, state) {
                        return OutlineTextfieldWidget(
                          key: const ValueKey('horarioTrabajo'),
                    ...
                    const Gap(30),
                    OutlineTextfieldWidget(
                      key: const ValueKey('horarioVisita'),

...
import 'package:core_financiero_app/src/presentation/widgets/solicitudes/ni/nueva_menor/sending/sending_form_widget.dart';
        ...
        child: Column(
          children: [
            ...
            SearchDropdownWidget(
              ...
              validator: (value) => ClassValidator.validateRequired(parentesco),
            ...
            SearchDropdownWidget(
              selectedItem: Item(
                ...
                value: parentescoBeneficiarioSeguro1,
              ),
              hintText: 'input.select_option'.tr(),
              codigo: 'PARENTESCO',

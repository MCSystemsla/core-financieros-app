              ...
              children: [
                ...
                if (estadoCivil == 'UNI' || estadoCivil == 'CAS') ...[
                  ...
                  CatalogoValorNacionalidad(
                    key: const Key('nacionalidadConyuge'),
                    ...
                    selectedItem: ItemNacionalidad(
                      ...
                      nombre: nacionalidadConyugueVer ?? '',
                      relacion: '',
                    ),
                    codigo: 'PAIS',
                    onChanged: (item) {
                  ...
                  if (trabajaConyuge == 'input.yes'.tr()) ...[
                    ...
                    const Gap(20),
                    OutlineTextfieldWidget(
                      key: const Key('direccionTrabajoConyuge'),
                      validator: (value) => ClassValidator.validateRequired(
                        value,
                      ),
                      inputFormatters: [
                    ...
                    const Gap(20),
                    OutlineTextfieldWidget(
                      key: const Key('telefonoTrabajoConyuge'),
                      validator: (value) => ClassValidator.validateRequired(
                        value,
                      ),
                      inputFormatters: [
                ...
                if (esFamiliarEmpleado == 'input.yes'.tr()) ...[
                  const Gap(20),
                  OutlineTextfieldWidget(
                    key: const Key('nombreFamiliarEmpleado'),
                    validator: (value) => ClassValidator.validateRequired(
                      value,
                    ),
                    inputFormatters: [
                  ...
                  const Gap(20),
                  OutlineTextfieldWidget(
                    key: const Key('cedulaFamiliarEmpleado'),
                    validator: (value) => ClassValidator.validateRequired(
                      value,
                    ),
                    inputFormatters: [

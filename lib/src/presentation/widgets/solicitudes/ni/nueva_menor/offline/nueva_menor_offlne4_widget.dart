...
class _NuevaMenorOfflne4WidgetState extends State<NuevaMenorOfflne4Widget>
  ...
  void initState() {
    ...
    actividadEconomica2 = widget.responseLocalDb.objActividadId2;
    ...
    [actividad, actividad1, actividadEconomica2]
        ...
        .forEach(
            (e) => actividadesPredominantesList.add(Item(name: e!, value: e)));
    [
      rubroActividad,
      rubroActividad2,
      rubroActividad3
    ].where((e) => e != null && e.isNotEmpty).forEach(
        (e) => rubrosActividadesPredominanteList.add(Item(name: e!, value: e)));
            ...
            child: Column(
              children: [
                ...
                SearchDropdownWidget(
                  selectedItem: Item(
                    name: condicionNegocioVer ?? '',
                    value: condicionNegocio,
                  ),
                  codigo: 'TIPOVIVIENDA',
                  onChanged: (item) {
                    if (item == null) return;
                ...
                SearchDropdownWidget(
                  selectedItem: Item(
                    name: actividadEconomica2Ver ?? '',
                    value: actividadEconomica2,
                  ),
                  hintText: 'input.select_option'.tr(),
                  codigo: 'ACTIVIDADECONOMICA',
                  title: 'Actividad 3',
                ...
                if (actividad == 'AGRI') ...[
                  ...
                  SearchDropdownWidget(
                    selectedItem: Item(
                      name: rubroActividadVer ?? '',
                      value: rubroActividad,
                    ),
                    hintText: 'input.select_option'.tr(),
                    validator: (value) =>
                        ClassValidator.validateRequired(value?.value),
                ...
                if (actividad1 == 'AGRI') ...[
                  ...
                  SearchDropdownWidget(
                    selectedItem: Item(
                      name: rubroActividad2Ver ?? '',
                      value: rubroActividad2,
                    ),
                    hintText: 'input.select_option'.tr(),
                    validator: (value) =>
                        ClassValidator.validateRequired(value?.value),
                ...
                if (actividadEconomica2 == 'AGRI') ...[
                  ...
                  SearchDropdownWidget(
                    selectedItem: Item(
                      name: rubroActividad3Ver ?? '',
                      value: rubroActividad3,
                    ),
                    hintText: 'input.select_option'.tr(),
                    validator: (value) =>
                        ClassValidator.validateRequired(value?.value),
                ...
                CatalogoValorNacionalidad(
                  selectedItem: ItemNacionalidad(
                    id: 0,
                    valor: departamentoNegocio?.value ?? '',
                    nombre: departamentoNegocio?.name ?? '',
                    relacion: '',
                  ),
                  where: context

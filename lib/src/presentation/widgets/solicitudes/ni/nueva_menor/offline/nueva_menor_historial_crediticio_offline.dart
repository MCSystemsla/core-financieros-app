...
class NuevaMenorHistorialCrediticioOffline extends StatefulWidget {
  final String uuid;
  final PageController controller;
  const NuevaMenorHistorialCrediticioOffline({
    super.key,
  ...
  @override
  State<NuevaMenorHistorialCrediticioOffline> createState() =>
      _NuevaMenorHistorialCrediticioOfflineState();
}

class _NuevaMenorHistorialCrediticioOfflineState
    extends State<NuevaMenorHistorialCrediticioOffline> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final historialesCreditos =
        context.watch<SolicitudNuevaMenorCubit>().state.historialCredito;
    final localDbProvider = global<ObjectBoxService>();

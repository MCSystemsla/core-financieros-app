              ...
              children: [
                ...
                OutlineTextfieldWidget.withCounter(
                  ...
                  onChange: (value) {
                    ...
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(profesion: profesion),
                    );
                  },
                ),
                const Gap(20),
                OutlineTextfieldWidget(
                  ...
                  onChange: (value) {
                    ocupacion = value;
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(ocupacion: ocupacion),
                    );
                  },
                ),
                const Gap(20),
                OutlineTextfieldWidget(
                  ...
                  onChange: (value) {
                    nombreNegocio = value;
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(nombreNegocio: nombreNegocio),
                    );
                  },
                ),
                const Gap(20),
                  ...
                  onChanged: (item) {
                    ...
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(
                        ...
                        objCondicionNegocioIdVer: condicionNegocio?.name,
                      ),
                    );
                  },
                ...
                OutlineTextfieldWidget(
                  ...
                  onChange: (value) {
                    barrioNegocio = value;
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(barrioNegocio: barrioNegocio),
                    );
                  },
                ),
                const Gap(20),
                OutlineTextfieldWidget.withCounter(
                  ...
                  onChange: (value) {
                    ...
                    cubit.onFieldChanged(
                      () => cubit.state
                          .copyWith(direccionNegocio: direccionNegocio),
                    );
                  },
                ),
                const Gap(20),

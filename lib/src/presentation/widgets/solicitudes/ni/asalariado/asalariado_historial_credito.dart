...
class AsalariadoHistorialCredito extends StatefulWidget {
  final PageController controller;
  const AsalariadoHistorialCredito({
    super.key,
    required this.controller,
  });

  @override
  State<AsalariadoHistorialCredito> createState() =>
      _AsalariadoHistorialCreditoState();
}

class _AsalariadoHistorialCreditoState
    extends State<AsalariadoHistorialCredito> {
  @override
  Widget build(BuildContext context) {
    final cubit = context.watch<SolicitudAsalariadoCubit>().state;

...
class AsalariadoHistorialCreditoOffline extends StatefulWidget {
  final PageController controller;
  final String uuid;
  const AsalariadoHistorialCreditoOffline({
    super.key,
  ...
  @override
  State<AsalariadoHistorialCreditoOffline> createState() =>
      _AsalariadoHistorialCreditoOfflineState();
}

class _AsalariadoHistorialCreditoOfflineState
    extends State<AsalariadoHistorialCreditoOffline> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final historialesCreditos =
        context.watch<SolicitudAsalariadoCubit>().state.historialCredito;
    final localDbProvider = global<ObjectBoxService>();
              ...
              onTap: () => showHistorialCreditoOptionsBottomSheet(
                ...
                onEdit: () {
                  _createCreditoModalBottomSheet(
                    context,
                    cubit: context.read<SolicitudAsalariadoCubit>(),
                    isUpdate: true,
                    cuota: e.cuota,
                    saldo: e.saldo,
                    estadoCodigo: e.estadoCodigo,
...
_createCreditoModalBottomSheet(
  ...
  required SolicitudAsalariadoCubit cubit,
  bool isUpdate = false,
  String? entidad,
  int? monto,
...
class CreateCreditoContainerForm extends StatefulWidget {
  final bool isUpdate;
  final SolicitudAsalariadoCubit cubit;

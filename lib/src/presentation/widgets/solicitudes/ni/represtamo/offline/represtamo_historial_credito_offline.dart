...
class ReprestamoHistorialCreditoOffline extends StatefulWidget {
  final PageController controller;
  final String uuid;
  const ReprestamoHistorialCreditoOffline({
    super.key,
  ...
  @override
  State<ReprestamoHistorialCreditoOffline> createState() =>
      _ReprestamoHistorialCreditoOfflineState();
}

class _ReprestamoHistorialCreditoOfflineState
    extends State<ReprestamoHistorialCreditoOffline> {
  @override
  void initState() {
    super.initState();

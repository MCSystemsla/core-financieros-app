...
class EnergiaLimpiaTieneProblemaEnergia extends StatefulWidget {
  const EnergiaLimpiaTieneProblemaEnergia({
    super.key,
  });

  @override
  State<EnergiaLimpiaTieneProblemaEnergia> createState() =>
      _EnergiaLimpiaTieneProblemaEnergiaState();
}

class _EnergiaLimpiaTieneProblemaEnergiaState
    extends State<EnergiaLimpiaTieneProblemaEnergia> {
  bool onEditAnswer = false;
  String? newTieneProblemas;
  @override
    ...
    return WhiteCard(
      child: Column(
        ...
        children: [
          ...
          const Gap(20),
          Text(
            energiaLimpiaProvider.state.tieneProblemasEnergia
                ? 'input.yes'.tr()
                : 'input.no'.tr(),
                  ...
                  onPressed: () {
                    context.read<RecurrenteEnergiaLimpiaCubit>().saveAnswer2(
                          tieneProblemasEnergia:
                              newTieneProblemas == 'input.yes'.tr(),
                        );
                    onEditAnswer = !onEditAnswer;
                    setState(() {});
                  },

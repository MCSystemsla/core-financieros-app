...
class TableInventarioMenorMilNi extends StatefulWidget {
  final int numeroSolicitud;
  const TableInventarioMenorMilNi({
    super.key,
    required this.numeroSolicitud,
  });

  @override
  State<TableInventarioMenorMilNi> createState() =>
      _TableInventarioMenorMilState();
}

class _TableInventarioMenorMilState extends State<TableInventarioMenorMilNi> {
  @override

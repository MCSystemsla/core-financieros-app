...
class TableVentasCardMonthsNiWidget extends StatefulWidget {
  const TableVentasCardMonthsNiWidget({super.key});

  @override
  State<TableVentasCardMonthsNiWidget> createState() =>
      _TableVentasCardMonthsHnWidgetState();
}

class _TableVentasCardMonthsHnWidgetState
    extends State<TableVentasCardMonthsNiWidget> {
  @override
...
class CreateValorizacionMesNI extends StatefulWidget {
  ...
  @override
  State<CreateValorizacionMesNI> createState() =>
      _CreateValorizacionMesHNState();
}

class _CreateValorizacionMesHNState extends State<CreateValorizacionMesNI> {

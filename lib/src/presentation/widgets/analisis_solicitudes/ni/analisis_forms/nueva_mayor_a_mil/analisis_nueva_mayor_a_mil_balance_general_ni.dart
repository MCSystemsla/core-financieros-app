...
import 'package:core_financiero_app/src/presentation/widgets/analisis_solicitudes/ni/analisis_forms/nueva_mayor_a_mil/tables/table_pasivos_fijos_ni_widget.dart';
...
class AnalisisMayorAMilBalanceGeneralNI extends StatefulWidget {
  const AnalisisMayorAMilBalanceGeneralNI({
    super.key,
  ...
  @override
  State<AnalisisMayorAMilBalanceGeneralNI> createState() =>
      _AnalisisMayorAMilBalanceGeneralHNState();
}

class _AnalisisMayorAMilBalanceGeneralHNState
    extends State<AnalisisMayorAMilBalanceGeneralNI> {
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                AnalisisCardListHn(
                  title:
                      'Proveedores, adelantos de clientes, impuestos y otros',
                  maxLines: 4,
                  onTap: () {
                    Navigator.push(
                      context,
                ...
                const Gap(20),
                AnalisisCardListHn(
                  title: 'Otros créditos, bancos, ONG, amigos y otros',
                  maxLines: 3,
                  onTap: () {
                    Navigator.push(
                      context,
                  ...
                  items: [
                    ...
                    AnalisisCardItem(
                      icon: Icons.business,
                      label: 'Patrimonio',
                      value: (totalActivos - (totalPasivos + otrosCreditos))
                          .toCurrencyString(),
                      color: Colors.brown,
                    ),
                    AnalisisCardItem(

...
class AnalisisMayorMilSendingFormNi extends StatefulWidget {
  final int numeroSolicitud;
  const AnalisisMayorMilSendingFormNi({
    super.key,
    required this.numeroSolicitud,
  });

  @override
  State<AnalisisMayorMilSendingFormNi> createState() =>
      _AnalisisMayorMilSendingFormState();
}

class _AnalisisMayorMilSendingFormState
    extends State<AnalisisMayorMilSendingFormNi> {
  @override
  void initState() {
    super.initState();
    context
  ...
  Widget build(BuildContext context) {
    final numeroSolicitud = widget.numeroSolicitud == 0
        ? ''
          ...
          body: switch (state.status) {
            Status.inProgress => SendingStatusView(
                ...
                steps: const [
                  ...
                  SendingStep(label: 'Registrando balance y estado resultado'),
            ...
            Status.done => SendingStatusView(
                ...
                steps: const [
                  ...
                  SendingStep(
                    label: 'Balance y estado resultado registrados',
                    state: SendingStepState.done,
                  ),
                  SendingStep(

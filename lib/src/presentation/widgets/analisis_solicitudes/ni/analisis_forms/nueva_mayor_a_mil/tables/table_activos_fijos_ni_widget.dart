...
class TableActivosFijosNiWidget extends StatelessWidget {
  const TableActivosFijosNiWidget({super.key});
        ...
        return AnalisisCardVentasDay(
          ...
          onTap: () => {
            showHistorialCreditoOptionsBottomSheet(
              ...
              onDelete: () {
                context.read<AnalisisNuevaMayorMilNiCubit>().deleteActivo(
                      numeroSolicitud: numeroSolicitud,
                      uuid: e.uuid,
                    );
              },

...
class TablePasivosFijosNiWidget extends StatelessWidget {
  const TablePasivosFijosNiWidget({super.key});
        ...
        return AnalisisCardVentasDay(
          ...
          onTap: () => {
            showHistorialCreditoOptionsBottomSheet(
              ...
              onDelete: () {
                context.read<AnalisisNuevaMayorMilHnCubit>().deletePasivo(
                      numeroSolicitud: numeroSolicitud,
                      uuid: e.uuid,
                    );
              },
...
class _CompraPorArticuloSheetHnState extends State<_CompraPorArticuloSheetHn> {
  ...
  void initState() {
    super.initState();
    if (widget.isUpdate && widget.pasivo != null) {
      nombre = widget.pasivo!.nombreProveedores;
      monto = widget.pasivo!.monto;
    }
  }
                    ...
                    Container(
                      ...
                      child: CustomElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          if (widget.isUpdate) {
                            widget.cubit.updatePasivosFijos(
                              numeroSolicitud: widget.numeroSolicitud,
                              pasivo: AnalisisPasivoHnLocalDb(
                                uuid: widget.pasivo!.uuid,

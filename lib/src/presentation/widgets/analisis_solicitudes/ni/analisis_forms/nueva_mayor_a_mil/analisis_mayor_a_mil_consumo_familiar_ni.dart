...
class AnalisisMayorAMilConsumoFamiliaresNi extends StatefulWidget {
  const AnalisisMayorAMilConsumoFamiliaresNi({
    super.key,
  ...
  @override
  State<AnalisisMayorAMilConsumoFamiliaresNi> createState() =>
      _AnalisisMayorAMilConsumoFamiliaresState();
}

class _AnalisisMayorAMilConsumoFamiliaresState
    extends State<AnalisisMayorAMilConsumoFamiliaresNi> {
        ...
        return SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                AnalisisMayorAMilCostoPersonalNi(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(

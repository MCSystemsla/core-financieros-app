...
class TableOtrosCreditosNiWidget extends StatelessWidget {
  const TableOtrosCreditosNiWidget({super.key});
    ...
    return BlocBuilder<AnalisisNuevaMayorMilNiCubit,
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          appBar: AppBar(
            title: const Text('Otros creditos'),
          ),
...
class _NivelProduccionWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (otrosCreditos.isEmpty) {
      return const EmptyListWidget(message: 'No hay creditos para mostrar');
    }
    return ListView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
      itemCount: otrosCreditos.length,
      itemBuilder: (context, index) {
        final e = otrosCreditos[index];
        return AnalisisCardVentasDay(
          ...
          onTap: () => {
            showHistorialCreditoOptionsBottomSheet(
              ...
              onDelete: () {
                context.read<AnalisisNuevaMayorMilNiCubit>().deleteOtroCredito(
                      numeroSolicitud: numeroSolicitud,
                      uuid: e.uuid,
                    );
              },

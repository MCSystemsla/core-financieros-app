...
class AnalisisAsalariadoReferenciasNi extends StatefulWidget {
  final PageController pageController;
  const AnalisisAsalariadoReferenciasNi({
    super.key,
    required this.pageController,
  });

  @override
  State<AnalisisAsalariadoReferenciasNi> createState() =>
      _AnalisisAsalariadoReferenciasHnState();
}

class _AnalisisAsalariadoReferenciasHnState
    extends State<AnalisisAsalariadoReferenciasNi> {

...
class SendingAnalisisAsalariadoFormNi extends StatefulWidget {
  ...
  @override
  State<SendingAnalisisAsalariadoFormNi> createState() =>
      _SendingAnalisisAsalariadoFormHnState();
}

class _SendingAnalisisAsalariadoFormHnState
    extends State<SendingAnalisisAsalariadoFormNi> {
  @override
  void initState() {
    super.initState();
          ...
          body: switch (state.status) {
            Status.inProgress => SendingStatusView(
                ...
                steps: const [
                  ...
                  SendingStep(label: 'Registrando ingresos y egresos'),
            ...
            Status.done => SendingStatusView(
                ...
                message:
                    'El análisis de asalariado quedó registrado correctamente.',
                steps: const [
                  SendingStep(
                  ...
                  SendingStep(
                    label: 'Ingresos y egresos registrados',
                    state: SendingStepState.done,
                  ),
                  SendingStep(

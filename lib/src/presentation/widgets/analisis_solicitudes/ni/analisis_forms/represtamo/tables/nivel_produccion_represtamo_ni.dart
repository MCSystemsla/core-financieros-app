...
class NivelProduccionReprestamoNi extends StatelessWidget {
  const NivelProduccionReprestamoNi({super.key});
        ...
        return AnalisisCardVentasDay(
          ...
          onTap: () => {
            showHistorialCreditoOptionsBottomSheet(
              ...
              onDelete: () {
                context.read<AnalisisReprestamoNiCubit>().deleteNivelProduccion(
                      uuid: e.uuid!,
                      numeroSolicitud: numeroSolicitud,
                    );
              },

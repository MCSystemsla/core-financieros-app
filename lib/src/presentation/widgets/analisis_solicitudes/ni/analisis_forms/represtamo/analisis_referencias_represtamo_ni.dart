...
class AnalisisReferenciasReprestamoNI extends StatefulWidget {
  final PageController pageController;
  const AnalisisReferenciasReprestamoNI({
    super.key,
    required this.pageController,
  });

  @override
  State<AnalisisReferenciasReprestamoNI> createState() =>
      _AnalisisReferenciasReprestamoHNState();
}

class _AnalisisReferenciasReprestamoHNState
    extends State<AnalisisReferenciasReprestamoNI> {

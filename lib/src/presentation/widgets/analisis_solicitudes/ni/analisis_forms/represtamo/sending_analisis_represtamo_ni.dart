...
class SendingAnalisisReprestamoNi extends StatefulWidget {
  const SendingAnalisisReprestamoNi({super.key});

  @override
  State<SendingAnalisisReprestamoNi> createState() =>
      _SendingAnalisisReprestamoHnState();
}

class _SendingAnalisisReprestamoHnState
    extends State<SendingAnalisisReprestamoNi> {
  @override
  void initState() {
    super.initState();
    context.read<AnalisisReprestamoNiCubit>().createAnalisisReprestamo();
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AnalisisReprestamoNiCubit, AnalisisReprestamoNiState>(
          ...
          body: switch (state.status) {
            Status.inProgress => SendingStatusView(
                ...
                steps: const [
                  ...
                  SendingStep(label: 'Registrando estados financieros'),
            ...
            Status.done => SendingStatusView(
                ...
                message:
                    'El análisis de represtamo quedó registrado correctamente.',
                steps: const [
                  SendingStep(
                  ...
                  SendingStep(
                    label: 'Estados financieros registrados',
                    state: SendingStepState.done,
                  ),
                  SendingStep(

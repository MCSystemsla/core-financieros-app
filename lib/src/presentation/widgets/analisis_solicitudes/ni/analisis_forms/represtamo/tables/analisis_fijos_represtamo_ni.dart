...
class AnalisisFijosReprestamoNi extends StatelessWidget {
  final int numeroSolicitud;
  const AnalisisFijosReprestamoNi({super.key, required this.numeroSolicitud});
        ...
        return AnalisisCardVentasDay(
          ...
          onTap: () => {
            showHistorialCreditoOptionsBottomSheet(
              ...
              onDelete: () {
                context.read<AnalisisReprestamoNiCubit>().deleteActivo(
                      numeroSolicitud: numeroSolicitud,
                      uuid: e.uuid,
                    );
              },

...
class AnalisisBalanceGeneralReprestamoNI extends StatefulWidget {
  const AnalisisBalanceGeneralReprestamoNI({
    super.key,
  ...
  @override
  State<AnalisisBalanceGeneralReprestamoNI> createState() =>
      _AnalisisBalanceGeneralReprestamoHNState();
}

class _AnalisisBalanceGeneralReprestamoHNState
    extends State<AnalisisBalanceGeneralReprestamoNI> {
  @override
  void initState() {
    super.initState();

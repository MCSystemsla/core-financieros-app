...
class AnalisisConstanciaPermisosReprestamoNI extends StatefulWidget {
  final PageController pageController;
  const AnalisisConstanciaPermisosReprestamoNI({
    super.key,
    required this.pageController,
  });

  @override
  State<AnalisisConstanciaPermisosReprestamoNI> createState() =>
      _AnalisisConstanciaPermisosReprestamoHNState();
}

class _AnalisisConstanciaPermisosReprestamoHNState
    extends State<AnalisisConstanciaPermisosReprestamoNI> {

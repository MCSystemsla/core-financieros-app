...
class AnalisisMenorMilForm1Ni extends StatefulWidget {
  const AnalisisMenorMilForm1Ni({
    super.key,
  ...
  @override
  State<AnalisisMenorMilForm1Ni> createState() => _AnalisisMenorMilForm1State();
}

class _AnalisisMenorMilForm1State extends State<AnalisisMenorMilForm1Ni> {

...
class AnalisisMenorMilForm2Ni extends StatefulWidget {
  final PageController pageController;
  final AnalisisSolicitudesInterceptorType tipoSolicitud;

  const AnalisisMenorMilForm2Ni({
    super.key,
  ...
  @override
  State<AnalisisMenorMilForm2Ni> createState() => _AnalisisMenorMilForm2State();
}

class _AnalisisMenorMilForm2State extends State<AnalisisMenorMilForm2Ni> {

...
class AnalisisMenorMilForm3Ni extends StatefulWidget {
  final PageController pageController;
  const AnalisisMenorMilForm3Ni({super.key, required this.pageController});

  @override
  State<AnalisisMenorMilForm3Ni> createState() => _AnalisisMenorMilForm3State();
}

class _AnalisisMenorMilForm3State extends State<AnalisisMenorMilForm3Ni> {

...
class AnalisisMenorMilForm4Ni extends StatefulWidget {
  final PageController pageController;
  const AnalisisMenorMilForm4Ni({super.key, required this.pageController});

  @override
  State<AnalisisMenorMilForm4Ni> createState() => _AnalisisMenorMilForm4State();
}

class _AnalisisMenorMilForm4State extends State<AnalisisMenorMilForm4Ni> {

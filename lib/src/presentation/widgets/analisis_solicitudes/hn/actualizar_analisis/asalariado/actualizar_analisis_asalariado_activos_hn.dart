...
class ActualizarAnalisisAsalariadoActivosHN extends StatelessWidget {
  const ActualizarAnalisisAsalariadoActivosHN({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ActualizarAnalisisAsalariadoHnCubit,
                  ...
                  children: [
                    ...
                    OutlineTextfieldWidget(
                      ...
                      onChange: (value) {
                        ...
                        cubit.onFieldChanged(
                          () => state.copyWith(
                              valoresAcciones: int.tryParse(newValue)),
                        );
                      },
                    ),
                    const Gap(20),
                    ...
                    OutlineTextfieldWidget(
                      ...
                      onChange: (value) {
                        ...
                        cubit.onFieldChanged(
                          () => state.copyWith(
                              bienesInmuebles: int.tryParse(newValue)),
                        );
                      },
                    ),
                    const Gap(20),
                    OutlineTextfieldWidget(
                      textAlign: TextAlign.end,
                      hintText:
                          totalActivosCalc.toCurrencyString(mantissaLength: 0),
                      readOnly: true,
                      title: 'Total activos:',
                      icon: const Icon(Icons.document_scanner),
                      textInputType: TextInputType.number,

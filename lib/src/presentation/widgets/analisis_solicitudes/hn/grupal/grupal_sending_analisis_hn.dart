...
class GrupalSendingAnalisisHn extends StatefulWidget {
  const GrupalSendingAnalisisHn({super.key});

  @override
  State<GrupalSendingAnalisisHn> createState() =>
      _GrupalSendingAnalisisHnState();
}

class _GrupalSendingAnalisisHnState extends State<GrupalSendingAnalisisHn> {
  @override
  void initState() {
    super.initState();
    context.read<AnalisisGrupalCubit>().createAnalisisGrupal();
  }
          ...
          body: switch (state.status) {
            Status.inProgress => SendingStatusView(
                ...
                steps: const [
                  ...
                  SendingStep(label: 'Registrando datos del grupo'),
                ],
            ...
            Status.done => SendingStatusView(
                ...
                message:
                    'El análisis grupal quedó registrado correctamente en el servidor.',
                steps: const [
                  SendingStep(
                  ...
                  SendingStep(
                    label: 'Datos del integrante registrados',
                    state: SendingStepState.done,
                  ),
                ],
                value: numeroSolicitud,
            ...
            Status.error => SendingStatusView(
                ...
                actions: [
                  CustomElevatedButton(
                    ...
                    onPressed: () {
                      context
                          .read<AnalisisGrupalCubit>()
                          .createAnalisisGrupal();
                    },
                  ),
                  CustomOutLineButton(
                    text: 'Volver',

...
class DerechoGarantiaForm extends StatefulWidget {
  final int objAnalisisGarantiaId;
  final String tipoPersonaCodigo;
  const DerechoGarantiaForm({
    super.key,
  ...
  @override
  State<DerechoGarantiaForm> createState() => _DerechoGarantiaFormState();
}

class _DerechoGarantiaFormState extends State<DerechoGarantiaForm> {
  int? cantidad;
              ...
              children: [
                ...
                OutlineTextfieldWidget(
                  ...
                  onChange: (value) {
                    descripcion = value;
                    cubit.onFieldChanged(
                      () => cubit.state.copyWith(descripcion: descripcion),
                    );
                  },
                ),
                const Gap(12),

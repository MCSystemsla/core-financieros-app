...
class VehiculoActualizarGarantiaForm extends StatefulWidget {
  ...
  const VehiculoActualizarGarantiaForm({
    super.key,
  ...
  @override
  State<VehiculoActualizarGarantiaForm> createState() =>
      _VehiculoActualizarGarantiaFormState();
}
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                OutlineTextfieldWidget(
                  title: 'Año',
                  initialValue: bien.anio.toString(),
                  icon: Icon(
                    Icons.inventory_2_outlined,
                    color: AppColors.getPrimaryColor(),
                  ),

...
class VehiculoGarantiaForm extends StatefulWidget {
  final int objAnalisisGarantiaId;
  final String tipoPersonaCodigo;

  const VehiculoGarantiaForm({
    super.key,
  ...
  @override
  State<VehiculoGarantiaForm> createState() => _VehiculoGarantiaFormState();
}

class _VehiculoGarantiaFormState extends State<VehiculoGarantiaForm> {
  int? cantidad;

...
class CrearDetalleBienHipotecario extends StatefulWidget {
  ...
  @override
  State<CrearDetalleBienHipotecario> createState() =>
      _CrearDetalleBienHipotecarioState();
}

class _CrearDetalleBienHipotecarioState
    extends State<CrearDetalleBienHipotecario> {
  String? departamento;
  String? municipio;
  String? aldea;
  String? numEscritura;
                ...
                BlocConsumer<AnalisisCreateGarantiaBienCubit,
                  ...
                  listener: (context, state) {
                    if (state.status == Status.inProgress) {
                      context.showLoading(message: 'Creando garantia detalle');
                    }

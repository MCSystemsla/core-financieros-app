...
class AnalisisGarantiaFormPrendarioMobiliario extends StatefulWidget {
  final int dpfsId;
  final int objAnalisisGarantiaID;
  final String? descripcion;
  final int? articuloGarantiaCodigo;
  const AnalisisGarantiaFormPrendarioMobiliario({
    super.key,
  ...
  @override
  State<AnalisisGarantiaFormPrendarioMobiliario> createState() =>
      _AnalisisGarantiaFormPrendarioMobiliarioState();
}

class _AnalisisGarantiaFormPrendarioMobiliarioState
    extends State<AnalisisGarantiaFormPrendarioMobiliario> {

...
class SendingAnalisisMenorMilHn extends StatefulWidget {
  final AnalisisSolicitudesInterceptorType tipoSolicitud;
  const SendingAnalisisMenorMilHn({super.key, required this.tipoSolicitud});

  @override
  State<SendingAnalisisMenorMilHn> createState() =>
      _SendingAnalisisReprestamoHnState();
}

class _SendingAnalisisReprestamoHnState
    extends State<SendingAnalisisMenorMilHn> {
  @override
  void initState() {
    super.initState();

...
part of 'analisis_menor_mil_ni_cubit.dart';

class AnalisisMenorMilNiState extends Equatable {
  final String? uuid;
  ...
  AnalisisMenorMilNiState copyWith({
    String? uuid,
    int? idLocalResponse,
    Status? status,
    String? errorMsg,
    ...
    return AnalisisMenorMilNiState(
      uuid: uuid ?? this.uuid,
...
final class AnalisisMenorMilInitial extends AnalisisMenorMilNiState {}

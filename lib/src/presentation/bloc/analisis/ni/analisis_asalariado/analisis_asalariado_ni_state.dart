...
part of 'analisis_asalariado_ni_cubit.dart';

class AnalisisAsalariadoNiState extends Equatable {
  ...
  const AnalisisAsalariadoNiState({
  ...
  AnalisisAsalariadoNiState copyWith({
    ...
    return AnalisisAsalariadoNiState(
...
final class AnalisisAsalariadoHnInitial extends AnalisisAsalariadoNiState {}

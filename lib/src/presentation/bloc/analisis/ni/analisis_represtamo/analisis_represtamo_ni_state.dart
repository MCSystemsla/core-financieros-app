...
part of 'analisis_represtamo_ni_cubit.dart';

class AnalisisReprestamoNiState extends Equatable {
  ...
  const AnalisisReprestamoNiState({
  ...
  AnalisisReprestamoNiState copyWith({
    ...
    return AnalisisReprestamoNiState(
...
final class AnalisisReprestamoInitial extends AnalisisReprestamoNiState {}

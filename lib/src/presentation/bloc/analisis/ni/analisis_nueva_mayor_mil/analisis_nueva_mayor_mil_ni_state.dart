...
part of 'analisis_nueva_mayor_mil_ni_cubit.dart';

class AnalisisNuevaMayorMilNiState extends Equatable {
  ...
  const AnalisisNuevaMayorMilNiState({
  ...
  AnalisisNuevaMayorMilNiState copyWith({
    int? numeroSolicitud,
    int? idLocalResponse,
    String? uuid,
    String? errorMsg,
    ...
    return AnalisisNuevaMayorMilNiState(
...
final class AnalisisNuevaMayorMilHnInitial
    extends AnalisisNuevaMayorMilNiState {}

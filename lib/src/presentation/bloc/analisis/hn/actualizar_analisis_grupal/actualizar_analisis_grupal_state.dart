...
part of 'actualizar_analisis_grupal_cubit.dart';

class ActualizarAnalisisGrupalState extends Equatable {
  final Status status;
  ...
  const ActualizarAnalisisGrupalState({
  ...
  ActualizarAnalisisGrupalState copyWith({
    Status? status,
    String? errorMessage,
    String? database,
    ...
    return ActualizarAnalisisGrupalState(
...
final class ActualizarAnalisisGrupalInitial
    extends ActualizarAnalisisGrupalState {}

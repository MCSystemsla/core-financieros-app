...
part of 'supervision_coordinador_cubit.dart';

class SupervisionCoordinadorState extends Equatable {
  ...
  const SupervisionCoordinadorState({
    this.errorMsg = '',
  ...
  SupervisionCoordinadorState copyWith({
    String? errorMsg,
    Status? status,
    String? database,
    int? numeroSolicitud,
    ...
    return SupervisionCoordinadorState(
...
final class SupervisionCoordinadorInitial extends SupervisionCoordinadorState {}

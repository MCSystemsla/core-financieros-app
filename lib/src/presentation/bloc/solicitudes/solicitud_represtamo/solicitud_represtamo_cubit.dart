  ...
  void saveAnswers({
    ...
    emit(
      state.copyWith(
        ...
        objFrecuenciaIdVer2: objFrecuenciaIdVer2,
        ...
        parentescoFamiliarVer: parentescoFamiliarVer,
        errorMsg: errorMsg,
        isOffline: isOffline,
    ...
    if (state.idLocalResponse != 0) {
      ...
      localDbProvider.updateSolicitudReprestamoById(
        ...
        responseReprestamoLocalDb: ReprestamoResponsesLocalDb(
          ...
          objFrecuenciaIdVer2: state.objFrecuenciaIdVer2,
          ...
          parentescoFamiliar: state.parentescoFamiliar,
          parentescoFamiliarVer: state.parentescoFamiliarVer,

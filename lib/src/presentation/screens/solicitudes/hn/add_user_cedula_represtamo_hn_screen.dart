...
class AddUserCedulaReprestamoHnScreen extends StatelessWidget {
  final TypeForm typeForm;
  const AddUserCedulaReprestamoHnScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (ctx) => UserByDocumentReprestamoCubit(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Form(
        key: formKey,
        child: Center(
          child: BlocConsumer<UserByDocumentReprestamoCubit,
              UserByDocumentReprestamoState>(
            listener: (context, state) {
              ...
              if (state.status == Status.done) {
                CustomAlertDialog(
                  context: context,
                  title: '${state.nombreCompleto} listo para crear solicitud!!',
                  onDone: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (ctx) => BlocProvider.value(
                          value: context.read<UserByDocumentReprestamoCubit>(),
                    ...
                    Container(
                      ...
                      child: CustomElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          context
                              .read<UserByDocumentReprestamoCubit>()
                              .getUserByDocument(

...
import 'package:core_financiero_app/src/presentation/widgets/solicitudes/ni/asalariado/asalariado_form.dart';
...
class CrearSolicitudScreenNi extends StatelessWidget {
  final TypeForm typeForm;
  final UserByCedulaSolicitud? userByCedulaSolicitud;

  const CrearSolicitudScreenNi({
    super.key,

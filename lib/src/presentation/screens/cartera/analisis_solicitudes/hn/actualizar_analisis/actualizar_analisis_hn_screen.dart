...
import 'package:core_financiero_app/src/presentation/widgets/analisis_solicitudes/hn/actualizar_analisis/menor_mil/actualizar_analisis_menor_mil_form1.dart';
import 'package:core_financiero_app/src/presentation/widgets/analisis_solicitudes/hn/actualizar_analisis/menor_mil/actualizar_analisis_menor_mil_form2.dart';
import 'package:core_financiero_app/src/presentation/widgets/analisis_solicitudes/hn/actualizar_analisis/menor_mil/actualizar_analisis_menor_mil_form3.dart';
import 'package:core_financiero_app/src/presentation/widgets/analisis_solicitudes/hn/actualizar_analisis/menor_mil/actualizar_analisis_menor_mil_form4.dart';
import 'package:core_financiero_app/src/presentation/widgets/analisis_solicitudes/hn/actualizar_analisis/menor_mil/actualizar_analisis_menor_mil_form5.dart';
...
class ActualizarAnalisisNuevaMenorMilScreen extends StatelessWidget {
  ...
  final String description;
  final int index;
  final AnalisisSolicitudesInterceptorType tipoSolicitudType;
  const ActualizarAnalisisNuevaMenorMilScreen({
    ...
    required this.description,
    required this.index,
    required this.tipoSolicitudType,
  });
                    ...
                    Expanded(
                      ...
                      child: SafeArea(
                        child: PageView(
                          ...
                          children: [
                            ActualizarAnalisisMenorMilForm1(
                              pageController: pageController,
                            ),
                            ActualizarAnalisisMenorMilForm2(
                              pageController: pageController,
                              tipoSolicitud: tipoSolicitudType,
                            ),
                            ActualizarAnalisisMenorMilForm3(
                              pageController: pageController,
                            ),
                            ActualizarAnalisisMenorMilForm4(
                              pageController: pageController,
                            ),

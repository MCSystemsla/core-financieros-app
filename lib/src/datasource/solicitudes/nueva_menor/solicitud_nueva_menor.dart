...
class SolicitudNuevaMenor {
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> data = {
      ...
      'Apellido2': apellido2,
      'Cedula': cedula,
      'PaisEmisorCedulaCodigo': objPaisEmisorCedula,
      ...
      'MunicipioCasaCodigo': objMunicipioCasaId,
      'DepartamentoCasaCodigo': objDepartamentoCasaId,
      'PaisCasaCodigo': objPaisCasaId,
      'Profesion': profesion,
      'Ocupacion': ocupacion,
      'Nacionalidad': nacionalidad,
      'CondicionCasaCodigo': objCondicionCasaId,
      ...
      'MunicipioNegocioCodigo': objMunicipioNegocioId,
      'CondicionNegocioCodigo': objCondicionNegocioId,
      'HorarioTrabajo': horarioTrabajo,
      'HorarioVisita': horarioVisita,
      'PersonasACargo': personasACargo,
      'EstadoCivilCodigo': objEstadoCivilId,
      ...
      'ParentescoBeneficiarioSeguro1Codigo': objParentescoBeneficiarioSeguroId1,
      ...
      'EscolaridadCodigo': objEscolaridadId,
      'CantidadHijos': cantidadHijos,
      'NombrePublico': nombrePublico,
      'SexoCodigo': objSexoId,
      'PaisNacimientoCodigo': objPaisNacimientoId,

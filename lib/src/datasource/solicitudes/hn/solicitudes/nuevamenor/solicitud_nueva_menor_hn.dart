...
class SolicitudNuevaMenorHn {
  ...
  Map<String, dynamic> toJson() {
    Map<String, dynamic> data = {
      ...
      'ActividadDescripcionConyugue': actividadDescripcionConyugue,
      'exeperiencia': exeperiencia.toString(),
      ...
      'ActividaEconomicaDescipcion1': actividaEconomicaDescipcion1,
      'ActividaEconomicaDescipcion2': actividaEconomicaDescipcion2,
      'ActividaEconomicaDescipcion3': actividaEconomicaDescipcion3,

...
class SupervisionData {
  ...
  factory SupervisionData.fromJson(Map<String, dynamic> json) =>
      SupervisionData(
        ...
        cuota: (json['Cuota'] as num?) ?? 0,
        razonEndeudamiento: (json['RazonEndeudamiento'] as num?) ?? 0,
        ...
        planInversionMonto: (json['PlanInversionMonto'] as num?)?.toInt() ?? 0,
        tiempoActividad: (json['TiempoActividad'] as num?)?.toInt() ?? 0,

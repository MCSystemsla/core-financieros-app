...
class UpdateAnalisisGrupalEndpoint extends Endpoint {
  final AnalisisGrupal data;
  UpdateAnalisisGrupalEndpoint({
    required this.data,
  });
  @override
  Method get method => Method.patch;
  ...
  @override
  String get path => '/cartera/analisis-grupales/actualizar-analisis-rapido';
  @override
  Map<String, String> get headers => {
        'Authorization': 'Bearer ${LocalStorage().jwt}',
      };
...
class GetAnalisisDataEndpoint extends Endpoint {
  final String numeroSolicitud;
  final String tipoSolicitud;

  GetAnalisisDataEndpoint({
    required this.numeroSolicitud,
    required this.tipoSolicitud,
  });
  @override
  ...
  @override
  String get path => '/cartera/solicitudes/general/analisis/data-by-number';
  @override
  Map<String, String> get headers => {
        'Authorization': 'Bearer ${LocalStorage().jwt}',
      };
